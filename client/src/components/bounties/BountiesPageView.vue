...
import { useBountiesPage } from "../../utils/composables/useBountiesPage.js";
...
<template>
  <div class="bounties-page">
    <header class="page-header mb-5">
      <h1>悬赏广场</h1>
      <p class="text-secondary">仅展示招募中的悬赏，点击卡片查看详情可进入对话。</p>
    </header>
