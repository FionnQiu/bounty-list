...
import { useBountyDetailPage } from "../../utils/composables/useBountyDetailPage.js";
...
<template>
  ...
  <section v-else-if="!detail" class="panel">
    <EmptyState title="悬赏加载失败" description="请刷新后重试。" />
  </section>

  <section v-else class="workspace workspace--detail detail-page">
